...
public class SkillMaim extends ActiveSkill {

    public SkillMaim(Heroes plugin) {
        super(plugin, "Maim");
        setDescription("You aim your next axe at your enemy's feet, slowing their movement speed.");
        setUsage("/skill maim");
        
        setArgumentRange(0, 1);
        setIdentifiers(new String[] { "skill Maim" });
    ...
    public ConfigurationSection getDefaultConfig() {
        ...
        node.set(SkillSetting.COOLDOWN.node(),25000);
    ...
    public SkillResult use(Hero hero, String[] args) {
        ...
        hero.addEffect(new com.herocraftonline.heroes.characters.effects.ExpirableEffect(this, "slowing-axes", duration));
