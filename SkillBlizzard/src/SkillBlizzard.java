...
public class SkillBlizzard extends ActiveSkill {
    ...
    public SkillBlizzard(Heroes plugin) {
        ...
        setDescription("Cast a blizzard over $1 radius from $2m away.");
        setUsage("/skill blizzard");
        
        setArgumentRange(0, 1);
        setIdentifiers(new String[] { "skill Blizzard" });
        ...
        Bukkit.getServer().getPluginManager().registerEvents(new SkillBlizzard.SkillEntityListener(this),plugin);
