...
public class SkillDragonStance extends ActiveSkill {

    public SkillDragonStance(Heroes plugin) {
        super(plugin, "DragonStance");
        setDescription("Activates dragon stance. Your attacks do bonus damage the lower your hunger is but you get less hungry with each strike");
        setUsage("/skill DragonStance");
        
        setArgumentRange(0, 1);
        setIdentifiers("skill DragonStance");
